...

{
  ...
  {
    path: 'feed',
    loadChildren: () => import('./pagina/feed/feed.module').then( m => m.FeedPageModule)
  },
  {
  path: 'descricao',
  loadChildren: () => import('./pagina/descricao/descricao.module').then( m => m.DescricaoPageModule)
},
  {
    path: 'publicacao',
    loadChildren: () => import('./pagina/publicacao/publicacao.module').then( m => m.PublicacaoPageModule)
  },
